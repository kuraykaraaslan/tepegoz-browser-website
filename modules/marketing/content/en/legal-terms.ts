      ...
      blocks: [
        {
          ...
          items: [
            ...
            'It is **pre-release software**. There is no stable version, no update channel, no security audit, and builds are unsigned.',
      ...
      blocks: [
        {
          ...
          items: [
            ...
            '**Automation can cause irreversible outcomes.** The software puts confirmations in front of actions it classifies as financial, credential-related or destructive, and those safeguards are not a guarantee. Judgement remains yours.',
            '**Do not use it for anything unlawful**, and do not use it to circumvent access controls or human-verification systems belonging to others.',
          ],
        },
      ],
    },
